...
export const create_invitee_table = () => {
  return "CREATE TABLE Invitee(invitee_no INT, invitee_name VARCHAR(50) NOT NULL, invited_by VARCHAR(50) NOT NULL,PRIMARY KEY(invitee_no))";
};
export const create_room_table = () => {
  return "CREATE TABLE Room(room_no INT, room_name VARCHAR(50) NOT NULL, floor_number INT NOT NULL, PRIMARY KEY(room_no))";
};
export const create_meeting_table = () => {
  return "CREATE TABLE Meeting(meeting_no INT, meeting_title VARCHAR(50) NOT NULL, starting_time DATETIME NOT NULL, ending_time DATETIME NOT NULL,room_no INT, PRIMARY KEY(meeting_no))";
};
